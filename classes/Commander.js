...
class Commander extends Astronaut {
    ...
    introduce() {
        console.log(' Greetings, I am Commander '+ this.name + ' engaged in the ' + this.mission +' mission holding the rank of ' + this.rank);
    }
    get rankInfo() {
...
const commander2 = new Commander('Michael Collins', 'Apollo 11', 'Major General');
